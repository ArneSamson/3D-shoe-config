  ...
  <menu>
      ...
      <div class="selections">
        <div :class="{ options: true }" @click="selectColor('black', 'sole')">
          <div
            :class="{
              circles: true,
              'selected-circle': selectedOption === 'black',
              black: true,
            }"
          ></div>
        ...
        <div
          :class="{ options: true }"
          @click="selectColor('dark-red', 'sole')"
        >
    ...
    <div v-if="currentPage === '2'">
      <div class="selections">
        ...
        <div
          :class="{ options: true }"
          @click="selectColor('dark-red', 'laces')"
        >
          <div class="circles dark-red"></div>
          <p>Dark Red</p>
        </div>
...
export default {
  ...
  methods: {
    ...
    assignColor(color) {
      const previouslySelectedCircle =
        document.querySelector(".selected-circle");
