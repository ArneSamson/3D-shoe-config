<template>
  <div class="shoe-configurator">
    <div
      class="loading-placeholder loading-placeholder--big" ref="loadingPlaceholder1">
          ...
          if (data && data.data && data.data.shoe && data.data.shoe._id) {
            ...
            this.$router.push({ path: "/thankyou", query: {
              ...
              shoeType: data.data.shoe.shoeType,
                ...
                shoeColorPanelDown: data.data.shoe.shoeColorPanelDown,
                shoeColorPanelUp: data.data.shoe.shoeColorPanelUp,
                shoeMaterialPanelDown: data.data.shoe.shoeMaterialPanelDown,
                shoeMaterialPanelUp: data.data.shoe.shoeMaterialPanelUp,
                jewel: data.data.shoe.jewel,
                initials: data.data.shoe.initials,
